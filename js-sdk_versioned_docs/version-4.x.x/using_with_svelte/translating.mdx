...
---
When you have Tolgee libraries installed and [`TolgeeProvider`](/using_with_svelte/api.mdx#tolgeeprovider) is set
...
You can also provide `defaultValue` prop to the [`T`](/using_with_svelte/api.mdx#t-component) component. This value will be used when no translation
...
[`getTranslate`](/using_with_svelte/api.mdx#gettranslate-function) method returning store containing

...
Tolgee offers two ways of wrapping, you can configure this through [wrapperMode](configuration#wrappermode).
...
([blog post](https://tolgee.io/blog/2021/12/17/invisible-characters-for-better-localization)).

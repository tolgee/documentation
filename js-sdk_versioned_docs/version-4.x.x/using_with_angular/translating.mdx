...
## Using pipe
To translate a string use [`translate`](/using_with_angular/api.mdx#translate-pipe) pipe.
...
## [Element with `t` attribute](/using_with_angular/api.mdx#tcomponent)
You can also use [element with `t`](/using_with_angular/api.mdx#tcomponent) attribute. Angular will render Tolgee component with `t` attribute selector.
```html
...
To translate texts in your component code use [`get`](/using_with_angular/api.mdx#method-get)
or [`instant`](/using_with_angular/api.mdx#method-instant)  method.
...
[`instant`](/using_with_angular/api.mdx#method-instant) method.
...
:::warning
Don't overuse [`instant`](/using_with_angular/api.mdx#method-instant) method. When it's possible
always use [`get`](/using_with_angular/api.mdx#method-get) method. When the translations are not loaded,
[`instant`](/using_with_angular/api.mdx#method-instant) method will not provide a valid result.
...
to [`get`](/using_with_angular/api.mdx#method-get) or
[`instant`](/using_with_angular/api.mdx#method-instant) functions.
...
[`stranslate`](/using_with_angular/api.mdx#stranslate-pipe) pipe,
[`getSafe`](/using_with_angular/api.mdx#method-getsafe) or
[`instantSafe`](/using_with_angular/api.mdx#method-instantsafe) methods.

Doing this will disable in-context localization for this string.

## Changing language

To change language, use [`setLang`](/using_with_angular/api.mdx#method-setlang) method of
[`translateService`](/using_with_angular/api.mdx#translateservice).
...
To obtain current language, use [`getCurrentLang`](/using_with_angular/api.mdx#method-getcurrentlang)
method of [`translateService`](/using_with_angular/api.mdx#translateservice).
...
To get HTML you can use [`TranslateService.getSafe`](/using_with_angular/api.mdx#method-getsafe) method.

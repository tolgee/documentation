...
description: Tolgee rebranding to new colors. We choose pink for it's modern and vibrant tone.
authors: [sgranat]
tags: ['brand', 'pink', 'rebranding', 'tolgee']
---

import { ReviewAuthor } from '../platform/shared/_ReviewAuthor';
import { ScreenshotWrapper } from '../platform/shared/_ScreenshotWrapper';

We're thrilled to introduce our refreshed brand, including our logo in a vibrant shade of pink, and a modern, user-friendly design for our app and website. We've heard your feedback, and we've taken it to heart.
...
**Matching dark mode**
<ScreenshotWrapper src="/img/blog/rebranding/tolgee-new-dark.png" alt="Tolgee dark mode" />
...
[![Rebranding invitation](/img/blog/rebranding/bottom-banner.svg)](https://app.tolgee.io/sign_up)
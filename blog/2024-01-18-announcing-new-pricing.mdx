...
with high machine translation prices. At the same time, we would like to focus on **improving the [Tolgee AI translator](/platform/translation_process/ai_translator)**
...
including the self-hosted ones. We will also charge one machine translation credit per character for the [Tolgee AI translator](/platform/translation_process/ai_translator).
  ...
  data={[
    {
      item: (
        <>
          Plan price (billed <b>annually</b>)
        </>
      ),
      oldValue: '€0',
      newValue: '€25/mo (300/year)',
      isNumber: true,
    },
    {
      item: (
        <>
          Plan price (billed <b>monthly</b>)
        </>
      ),
      oldValue: '€0',
      newValue: '€30/mo',
    ...
    {
      item: 'Price per 1000 MT credits',
      oldValue: '€0.20',
      newValue: '€0.035',
      isNumber: true,
    },
    {
      item: 'Included strings',
      oldValue: '1000',
      newValue: '4000',
      isNumber: true,
    },
    {
      ...
      newValue: (
        <>
          ...
          ,{' '}
          <a href="/platform/projects_and_organizations/ai-settings">
...
As an open-source project, you don't have to worry; we still provide the free business plan on the Tolgee Cloud. **Just reach us out at info@tolgee.io**.
...
Because of this, we decided to make the [Tolgee AI translator](/platform/translation_process/ai_translator) available also to customers who purchased a license
...
<PricingChanges
  data={[
    { item: 'Price per seat', oldValue: 'N/A', newValue: '10€' },
    {
      item: (
        <>
          Price per 1000 MT credits <br />
          (Only for <a href="/platform/translation_process/ai_translator">
            Tolgee AI translator
          </a> services, for other services, you can provide your own API key)
        </>
      ),
      oldValue: 'N/A',
      newValue: '€0.035',
    },
    {
      ...
      newValue: (
        <>
          <a href="/platform/projects_and_organizations/webhooks">Webhooks</a>,{' '}
          <a href="/platform/projects_and_organizations/content_delivery">
            Multiple content delivery configs
          </a>
          ,{' '}
          <a href="/platform/translation_process/ai_translator">
            Tolgee AI translator
          </a>
          ,{' '}
          <a href="/platform/projects_and_organizations/ai-settings">
...
Universal Format Support, Mobile SDKs, Document translations and [much more](https://tolgee.io/roadmap)**.

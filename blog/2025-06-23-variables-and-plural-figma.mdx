...
If your text contains any of these tags on the Tolgee platform, the plugin will automatically format the text in Figma. It works in the direction from Tolgee to Figma. So make sure to add them on the platform.

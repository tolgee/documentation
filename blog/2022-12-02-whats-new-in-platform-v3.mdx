...
All the integrations now use a unified `t` function interface, which is a bit different but cleaner and more straightforward [read more](/js-sdk/5.0.0-alpha.2/api/core_package/tolgee#t).

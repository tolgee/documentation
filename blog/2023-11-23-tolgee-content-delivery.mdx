...
title: 'Keep your translations out of the code'
...
Recently we've got many requests from our users to simplify the update of translations on production, and now we have an answer. Say Hi to Tolgee Content Delivery, a fast and reliable way to keep your translations independent of your code!
...
Utilizing Content Delivery Networks (CDNs), Tolgee Content Delivery guarantees lightning-fast access to your translated content worldwide. Our caching system ensures reliability, even across different geographical locations.
...
## Take automation to a new level with paid plans

Content delivery is part of our long-term effort to make localization easier and more autonomous. So we're also adding new possibilities to your paid plans.

### Webhooks

Do you want to react to certain events, that happen in Tolgee Platform? Now you can. Just set up a webhook and Tolgee will tell you what is happening!

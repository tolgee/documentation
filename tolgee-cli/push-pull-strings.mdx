...
Pushing and pulling strings from Tolgee is the most basic way to interact with strings. Similarly to a Git project, it
allows you to download strings from Tolgee to your computer (pull), or to upload them after you changed them (push).

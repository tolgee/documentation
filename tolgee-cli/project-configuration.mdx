...
Boolean. Require namespace to be reachable, turn off if you don't use namespaces. (Default: true)
...
[`react`, `vue`, `svelte`]. Tolgee detects which parser to use automatically from the extensions of matched files, with this option you can override it.

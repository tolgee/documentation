...
or because of a very specific use case. Magic comments to the rescue! They're a set of directives you can add in your
...
The simple form just takes the key name as argument. The detailed form takes a JSON5 object, that takes the `keyName`,
`ns`, and `defaultValue` properties.

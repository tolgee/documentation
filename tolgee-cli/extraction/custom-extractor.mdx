...
## Extractor sctructure
There is not much to know to know when writing a custom extractor. Here is the bare minimum file structure to follow:
...
All commands using code extraction allow you to specify a `--extractor` option, and takes a path to the extraction

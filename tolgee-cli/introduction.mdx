...
Tag your keys according to your current production code. So you can always know which strings are currently used in `production`. Which are `deprecated` and which are `drafts` in development branches.

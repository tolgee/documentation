...
With the introduction of Tolgee AI Translator, which uses ChatGPT under the hood, we can provide the Tolgee AI Translator with additional context. To obtain this context, the Tolgee SDK now collects data about the layout of the keys on your pages.

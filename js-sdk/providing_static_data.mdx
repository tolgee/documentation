...
Easiest way to get to your localization files on production is to [setup Tolgee Content Delivery](/platform/projects_and_organizations/content_delivery) and fetch the translations directly from there.

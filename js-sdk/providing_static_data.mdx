...
Tolgee tries to find the data in following way:
 ...
 1. Checks direct `staticData`, if data are accessible as plain object
...
Be careful about difference between static and dynamic values in `staticData`
...
You can also set a timeout, to only wait certain time (e.g. for the data from CDN):

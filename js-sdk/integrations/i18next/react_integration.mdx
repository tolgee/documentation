...
**Note**: `i18next-icu` has a peer dependency on `intl-messageformat`, so you will also need to install that.
See [their instructions](https://github.com/i18next/i18next-icu?tab=readme-ov-file#getting-started).

...
sidebar_label: App router + next-intl
title: Next.js with App Router and next-intl
description: "Get started with Tolgee's integration for Next.js. Learn how to add localization to your Next.js applications that uses the App Router and next-intl."
image: /img/og-images/next.png
--- package with router-based localization."
---

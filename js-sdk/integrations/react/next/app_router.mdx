...
export default async function IndexPage() {
  ...
  // Pass namespace to load translations from the namespace
  // const t = await getTranslate(['namespace']);
  const t = await getTranslate();
  return (
    <main>
      <h1>{t('hello_world')}</h1>
      {/* Alternatively, pass the namespace in the t-component */}
      {/* t('hello_world', { ns: 'namespace' }) */}
    </main>
  );
}
```
...
export const ExampleClientComponent = () => {
  ...
  return (
    <section>
      ...
      {/* Alternatively, pass the namespace in the t-component */}
      {/* t('example-key-in-client-component', { ns: 'namespace' }); */}

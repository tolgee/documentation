...
The client part is very similar to [pages router setup](./pages_router.mdx). It serves the purpose of translating client components and also enables in-context functionality for server-rendered components.

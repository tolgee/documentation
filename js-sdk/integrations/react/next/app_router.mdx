...
The applicaiton handles the loading of translation. The `i18n.ts` file is added as it is required by `next-intl`.

Create a `src/i18n.ts` file and paste the following code.

...
In this example we'll store language in cookies, which is a simple to implement, but is not ideal for your SEO. If you want a more robust solution with language in url, see [App router with next-intl](./app_router_next_intl.mdx)

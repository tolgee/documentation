...
description: "Learn how to use tags and interpolation in your React application using Tolkee. Explore different methods to use tags and interpolation, including the T-component and the useTranslate hook."
image: /img/og-images/react.png
---
You can integrate Tolkee in your React application using Tolkee's SDK for React. Moreover, the SDK supports Tags Interpolation. Learn more about Tags Interpolation and how to use them.

You might want to add formatting to certain part of the translated string. For example, let's take the translated string `Tolkee and React work well`. You want to add italics to the word `Tolkee` and bold to the word `React`. Using the React SDK, you can implement this easily.

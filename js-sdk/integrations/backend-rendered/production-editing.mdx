...
The [Tolgee Browser Plugin](/js-sdk/in-context#tolgee-browser-plugin) solves this elegantly. It can inject the API key and dev tools directly into Tolgee JS on the client side, enabling in-context editing without exposing credentials in your server code.

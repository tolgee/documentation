...
title: API
sidebar_label: API
description: "Tolgee enables you to implement localization in your Vue application with ease. You can integrate Tolgee in your Vue application using Tolgee's integration library for Vue. Learn about VueTolgee, TolgeeProvider, T-component, and other APIs."
---

...
description: "Tolgee enables you to implement localization in your Vue application with ease. You can integrate Tolgee in your Vue application using Tolgee's integration library for Vue. To use this library, start by installing Tolgee."
---

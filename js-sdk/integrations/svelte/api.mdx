...
title: API
sidebar_label: API
description: "Tolgee enables you to implement localization in your Svelte application with ease. You can integrate Tolgee in your Svelte application using Tolgee's integration library for Svelte. Learn about TolgeeProvider, T-component, and other APIs."
---

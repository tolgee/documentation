...
Tolgee SDK provides the functionality of an i18n library and helps you with [formatting](./js-sdk/formatting), interpolation, and [language detection](./js-sdk/language#language-detection).
The SDK also allows you to connect to the [Tolgee Platform](../platform/). It enables you to implement [in-context translation](./js-sdk/in-context) which also helps you generate one-click screenshots and edit translations directly in your app.

## In-context Translation

In-context translation helps you speed up development by saving you from tedious localization tasks. Using the Tolgee SDK, you can implement in-context translation. Learn more about in-context translation and how to implement it in your local development environment in [this documentation](./js-sdk/in-context).

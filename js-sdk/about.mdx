...
You can enable in-context translation in production, but it’s usually recommended only for development or staging. In production, use it only in controlled scenarios (for example, internal tools or admin access). Tolgee Tools are available as a [Chrome extension](https://chrome.google.com/webstore/detail/tolgee-tools/hacnbapajkkfohnonhbmegojnddagfnj) and also as a [Firefox add-on](https://addons.mozilla.org/en-US/firefox/addon/tolgee-tools/).
...
To help translators understand context, you can add screenshots. Capture them in one click using the [Tolgee Tools](https://chrome.google.com/webstore/detail/tolgee-tools/hacnbapajkkfohnonhbmegojnddagfnj) browser extension.

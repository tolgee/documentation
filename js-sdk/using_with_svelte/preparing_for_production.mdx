...
You have multiple options how to provide static i18n data to [`TolgeeProvider`](/using_with_svelte/api.mdx#tolgeeprovider) component.
...
[`TolgeeProvider's`](/using_with_svelte/api.mdx#tolgeeprovider) config prop.
...
supported language to [TolgeeProvider's](/using_with_svelte/api.mdx#tolgeeprovider) config prop.

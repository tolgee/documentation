...
## [`TolgeeProvider`](/using_with_svelte/api.mdx#tolgeeprovider)
...
(read more about [ICU message format](/docs/icu_message_format)).
...
`Writable<string>` - Writeable store containing the current language. (see [Switching language](/using_with_svelte/switching_language.mdx))

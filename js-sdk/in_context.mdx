...
For local development, supply `apiUrl`, `apiKey` options (see [Integration](/platform/integration)) and [`DevTools`](./api/web_package/bundled-plugins#devtools) plugin. If you set everything properly, you can use in-context translating:

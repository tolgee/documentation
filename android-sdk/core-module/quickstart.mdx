...
2*. Include Maven Central in repositories
...
So sure your repositories are configured to **include Maven Central for dependency resolution**.
...
**Enable Tolgee to fetch translations from the cloud at runtime**. To do that you need to **configure network access**.

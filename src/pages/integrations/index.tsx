...
import {TolgeeIsRealTexts, TrueIntegrationsFeature} from "../../component/pageComponents/featurePage/devTools/TrueIntegrationsFeature";
    ...
    <div className="flex flex-col">
      {Object.entries(integration.links).map(([label, link]) =>
        ...
        ><Link
          ...
          className={clsx(`relative hover:no-underline

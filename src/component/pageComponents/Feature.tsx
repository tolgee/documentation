...
export const Feature: FC<{ feature: FeatureData }> = (props) => {
  const section = sections.find(section => section.slug === props.feature.section).name

  return <a href={`/features/${props.feature.section}#${props.feature.id}`}
    ...
    <>
      ...
      <div className="mt-2">
      <span className="relative hover:no-underline

    ...
    <>
      ...
      <LandingPageFeatures>
        <LandingPageFeature>
          ...
          <p>
            To integrate {technologyName} to React project, you can just simply
            follow these docs, or use integration guides in Tolgee platform. You
            can do that in less than one minute.
          </p>
        </LandingPageFeature>
        <LandingPageFeature>

      ...
      languages: {
        'en': {
          consent_modal: {
            ...
            description: 'Hi, this website uses essential cookies to ensure ' +
            ...
            blocks: [
              {
                ...
                title: 'Analytics',
                description: 'We are using Google Analytics to analyze our traffic. Without these cookies, we would not be able to analyze ' +

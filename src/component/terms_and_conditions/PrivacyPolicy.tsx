            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              ...
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="body_text">
                  <span className="block-component" />
                  <span className="block-component" />
                  Services, <span className="statement-end-if-in-editor" />
                  <span className="block-component" />
                </span>
                <span data-custom-class="body_text">
                  <span style={{ fontSize: "15px" }}>
                ...
                <span data-custom-class="body_text">
                  ...
                  <span className="block-component" /> (such as by posting
                      ...
                      >
                        <span data-custom-class="body_text">
                          ...
                          >
                            ...
                            >
                              <span data-custom-class="body_text">
                                third parties. If we have processed your data
                                based on your consent and you wish to revoke
                                your consent, please contact us using the
                  ...
                  <ul>
                    <li style={{ lineHeight: "1.5" }}>
                      ...
                      >
                        ...
                        >
                          <span data-custom-class="body_text">
                            <span className="question">Payment Processors</span>
                          </span>
                        </span>
                      </span>
                    </li>
                  ...
                  <ul>
                    <li style={{ lineHeight: "1.5" }}>
                      ...
                      >
                        ...
                        >
                          <span data-custom-class="body_text">
                            <span className="question">Ad Networks</span>
                          </span>
                        </span>
                      </span>
                    </li>
                    ...
                    >
                      ...
                      >
                        <span data-custom-class="body_text">
                          ...
                          (EEA) or United Kingdom (UK), then these countries may
                          not necessarily have data protection laws or other
                                  ...
                                  <span style={{ color: "rgb(89, 89, 89)" }}>
                                    <span style={{ color: "rgb(89, 89, 89)" }}>
                                      <span data-custom-class="body_text">
                                        ...
                                        Records law, such as your name, contact
                            ...
                            <div style={{ lineHeight: "1.5" }}>
                                          ...
                                          >
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                ...
                                                to whom we disclosed personal
                                                information for a business or
                                                commercial purpose can be found
                                                under "
                                                <span
                                                  style={{
                                                    fontSize: "15px"
                                          ...
                                          >
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                ...
                                                provide information so that we
                                                can match it with information
                                                you have previously provided us.
                                            ...
                                            >
                                              ...
                                              >
                                                <span data-custom-class="body_text">
                                                  ...
                                                  request under the CCPA on your
                                                  behalf. We may deny a request
                                                  from an authorized agent that
                                                  does not submit proof that
                                            ...
                                            >
                                              ...
                                              >
                                                <span data-custom-class="body_text">
                                                  ...
                                                  parties. Upon receiving a
                                                  request to opt-out, we will
                                                  act upon the request as soon
                                                  as feasibly possible, but no
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  >
                                                    <strong>
                                                      <span data-custom-class="heading_1">
                                                        16. How do you comply with the Google API Services User Data Policy?
                                                      </span>
                                                    </strong>{" "}
                                                  </span>{" "}
                                                </span>{" "}
                              ...
                              <div style={{ lineHeight: "1.5" }}>
                                          ...
                                          >
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                Tolgee's use and transfer to any other app of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes">Google API Services User Data Policy</a>, including the Limited Use requirements.
                                              </span>
                                            </span>
                                          </span>
                              </div>

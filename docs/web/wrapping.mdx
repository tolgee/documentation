...
Let's try to discover the secret by console.logging individual characters of [`t`](./core-api/tolgee#t) function result:
...
calling [`tolgee.unwrap`](./core-api/tolgee#unwrap) method, which will give you the information about the translation.

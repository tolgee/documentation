...
Provides Tolgee context and takes care of running/stopping tolgee. Accepts [`Tolgee`](../core-package/tolgee) instance.
...
Use this hook to get `t` function, which can be used for imperative translating. You can also pass namespace(s), which you want to use. If no namespace is specified [`defaultNs`](../core-package/options#defaultns)
...
Read more about [`t` function](../core-package/tolgee#t)
...
Returns tolgee instance. Allows subscription to different [`events`](../core-package/events), which will trigger re-render.

...
### apiKey
Your api key, which can be [obtained using Tolgee web application.](/docs/platform/api-keys-and-pat-tokens).
...
You can obtain these files by [downloading them from Tolgee Web Application](/docs/platform/exporting_translations)

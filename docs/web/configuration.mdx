...
### apiKey
Your api key, which can be [obtained using Tolgee web application.](server_and_web_app/managing_api_keys.mdx)
...
Will determine how are translations wrapped

 - `text` (default) - uses [standard wrapping](./understanding_tolgee_for_web#key-and-parameters-wrapping)

...
When you have Tolgee libraries installed and [`TolgeeProvider`](/docs/web/svelte/api#tolgeeprovider) is set
...
You can also provide `defaultValue` prop to the [`T`](/docs/web/svelte/api#t-component) component. This value will be used when no translation
...
[`getTranslate`](/docs/web/svelte/api#gettranslate-function) method returning store containing

...
## [`TolgeeProvider`](/docs/web/svelte/api#tolgeeprovider)
...
`Writable<string>` - Writeable store containing the current language. (see [Switching language](/docs/web/svelte/switching_language))

...
You have multiple options how to provide static i18n data to [`TolgeeProvider`](/docs/web/svelte/api#tolgeeprovider) component.
...
[`TolgeeProvider's`](/docs/web/svelte/api#tolgeeprovider) config prop.
...
supported language to [TolgeeProvider's](/docs/web/svelte/api#tolgeeprovider) config prop.

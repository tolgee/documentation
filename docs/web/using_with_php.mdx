...
[exporting them using Tolgee Web Application](/docs/server_and_web_app/exporting_translations).
...
:::info
Inicialization has changed in [version 3](/docs/changelog/version_3)
:::
```html
...
### apiKey
Your secret key, which you can [obtain in web application](../server_and_web_app/managing_api_keys). (string, default: empty string)

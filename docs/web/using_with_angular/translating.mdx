...
Your programmatically translated texts will be not automatically updated in production mode. To do so, you will need to
...
To get HTML you can use `TranslateService.getSafe` method.

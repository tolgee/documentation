...
slug: /web/using_with_dart
description: "Learn about Dart integration oo Tolgee tool. This integration is meant to be used just in a browser. It will not work with other Dart platforms"
---
...
The configuration property names are the same as in Tolgee JS Core library. See [configuration](configuration).

...
You have multiple options how to provide static i18n data to [`TolgeeProvider`](/docs/web/vue/api#tolgeeprovider) component.
...
[`TolgeeProvider's`](/docs/web/vue/api#tolgeeprovider) config prop.
...
supported language to [TolgeeProvider's](/docs/web/vue/api#tolgeeprovider) config prop.

...
To translate a string use [`translate`](/docs/web/angular/api#translate-pipe) pipe.
...
## [Element with `t` attribute](/docs/web/angular/api#tcomponent)

You can also use [element with `t`](/docs/web/angular/api#tcomponent) attribute. Angular will render Tolgee component with `t` attribute selector.
...
To translate texts in your component code use [`get`](/docs/web/angular/api#method-get)
or [`instant`](/docs/web/angular/api#method-instant) method.
...
[`instant`](/docs/web/angular/api#method-instant) method.
...
:::warning
Don't overuse [`instant`](/docs/web/angular/api#method-instant) method. When it's possible
always use [`get`](/docs/web/angular/api#method-get) method. When the translations are not loaded,
[`instant`](/docs/web/angular/api#method-instant) method will not provide a valid result.
...
to [`get`](/docs/web/angular/api#method-get) or
[`instant`](/docs/web/angular/api#method-instant) functions.
...
[`stranslate`](/docs/web/angular/api#stranslate-pipe) pipe,
[`getSafe`](/docs/web/angular/api#method-getsafe) or
[`instantSafe`](/docs/web/angular/api#method-instantsafe) methods.

Doing this will disable in-context localization for this string.

## Changing language

To change language, use [`setLang`](/docs/web/angular/api#method-setlang) method of
[`translateService`](/docs/web/angular/api#translateservice).
...
To obtain current language, use [`getCurrentLang`](/docs/web/angular/api#method-getcurrentlang)
method of [`translateService`](/docs/web/angular/api#translateservice).
...
To get HTML you can use [`TranslateService.getSafe`](/docs/web/angular/api#method-getsafe) method.

...
Second parameter is object of translation parameters (see [parameter interpolation](parameter-interpolation)).
...
```javascript
tg.translate('hello_world', undefined).then((t) => {

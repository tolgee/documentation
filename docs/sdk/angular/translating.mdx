...
To translate a string use [`translate`](/docs/sdk/angular/api#translate-pipe) pipe.
...
## [Element with `t` attribute](/docs/sdk/angular/api#tcomponent)

You can also use [element with `t`](/docs/sdk/angular/api#tcomponent) attribute. Angular will render Tolgee component with `t` attribute selector.
...
To translate texts in your component code use [`get`](/docs/sdk/angular/api#method-get)
or [`instant`](/docs/sdk/angular/api#method-instant) method.
...
[`instant`](/docs/sdk/angular/api#method-instant) method.
...
:::warning
Don't overuse [`instant`](/docs/sdk/angular/api#method-instant) method. When it's possible
always use [`get`](/docs/sdk/angular/api#method-get) method. When the translations are not loaded,
[`instant`](/docs/sdk/angular/api#method-instant) method will not provide a valid result.
...
to [`get`](/docs/sdk/angular/api#method-get) or
[`instant`](/docs/sdk/angular/api#method-instant) functions.
...
[`stranslate`](/docs/sdk/angular/api#stranslate-pipe) pipe,
[`getSafe`](/docs/sdk/angular/api#method-getsafe) or
[`instantSafe`](/docs/sdk/angular/api#method-instantsafe) methods.

Doing this will disable in-context localization for this string.

## Changing language

To change language, use [`setLang`](/docs/sdk/angular/api#method-setlang) method of
[`translateService`](/docs/sdk/angular/api#translateservice).
...
To obtain current language, use [`getCurrentLang`](/docs/sdk/angular/api#method-getcurrentlang)
method of [`translateService`](/docs/sdk/angular/api#translateservice).
...
To get HTML you can use [`TranslateService.getSafe`](/docs/sdk/angular/api#method-getsafe) method.

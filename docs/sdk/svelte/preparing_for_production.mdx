...
You have multiple options how to provide static i18n data to [`TolgeeProvider`](/docs/sdk/svelte/api#tolgeeprovider) component.
...
[`TolgeeProvider's`](/docs/sdk/svelte/api#tolgeeprovider) config prop.
...
supported language to [TolgeeProvider's](/docs/sdk/svelte/api#tolgeeprovider) config prop.

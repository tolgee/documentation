...
## [`TolgeeProvider`](/docs/sdk/svelte/api#tolgeeprovider)
...
`Writable<string>` - Writeable store containing the current language. (see [Switching language](/docs/sdk/svelte/switching_language))

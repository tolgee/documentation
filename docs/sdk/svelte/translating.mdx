...
When you have Tolgee libraries installed and [`TolgeeProvider`](/docs/sdk/svelte/api#tolgeeprovider) is set
...
You can also provide `defaultValue` prop to the [`T`](/docs/sdk/svelte/api#t-component) component. This value will be used when no translation
...
[`getTranslate`](/docs/sdk/svelte/api#gettranslate-function) method returning store containing

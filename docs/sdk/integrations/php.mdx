...
In development mode this function will return `%-%tolgee:hello_world%-%`. This output is meant to be translated in browser by tolgee JS library. See [hello world example](../text_observer/hello-world).

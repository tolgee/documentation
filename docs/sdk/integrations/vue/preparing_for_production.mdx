...
You have multiple options how to provide static i18n data to [`TolgeeProvider`](/docs/sdk/integrations/vue/api#tolgeeprovider) component.
...
[`TolgeeProvider's`](/docs/sdk/integrations/vue/api#tolgeeprovider) config prop.
...
supported language to [TolgeeProvider's](/docs/sdk/integrations/vue/api#tolgeeprovider) config prop.

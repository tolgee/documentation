...
To translate a string use [`translate`](/docs/sdk/integrations/angular/api#translate-pipe) pipe.
...
To translate texts in your component code use [`get`](/docs/sdk/integrations/angular/api#method-get)
...
:::warning
Don't overuse [`instant`](/docs/sdk/integrations/angular/api#method-instant) method. When it's possible
always use [`get`](/docs/sdk/integrations/angular/api#method-get) method. When the translations are not loaded,
[`instant`](/docs/sdk/integrations/angular/api#method-instant) method will not provide a valid result.
...
to [`get`](/docs/sdk/integrations/angular/api#method-get) or
[`instant`](/docs/sdk/integrations/angular/api#method-instant) functions.
...
[`stranslate`](/docs/sdk/integrations/angular/api#stranslate-pipe) pipe,
[`getSafe`](/docs/sdk/integrations/angular/api#method-getsafe) or
[`instantSafe`](/docs/sdk/integrations/angular/api#method-instantsafe) methods.

Doing this will disable in-context localization for this string.

## Changing language

To change language, use [`setLang`](/docs/sdk/integrations/angular/api#method-setlang) method of
[`translateService`](/docs/sdk/integrations/angular/api#translateservice).
...
To obtain current language, use [`getCurrentLang`](/docs/sdk/integrations/angular/api#method-getcurrentlang)
method of [`translateService`](/docs/sdk/integrations/angular/api#translateservice).
...
To get HTML you can use [`TranslateService.getSafe`](/docs/sdk/integrations/angular/api#method-getsafe) method.

...
First, you will need to wrap your application code with [`TolgeeProvider`](/docs/sdk/integrations/svelte/api#tolgeeprovider) component.
...
Configuration properties for all web integrations are similar. They are described in [configuration](/docs/sdk/configuration)
section.

...
You have multiple options how to provide static i18n data to [`TolgeeProvider`](/docs/sdk/integrations/svelte/api#tolgeeprovider) component.
...
[`TolgeeProvider's`](/docs/sdk/integrations/svelte/api#tolgeeprovider) config prop.
...
supported language to [TolgeeProvider's](/docs/sdk/integrations/svelte/api#tolgeeprovider) config prop.

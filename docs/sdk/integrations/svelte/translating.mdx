...
When you have Tolgee libraries installed and [`TolgeeProvider`](/docs/sdk/integrations/svelte/api#tolgeeprovider) is set
...
You can also provide `defaultValue` prop to the [`T`](/docs/sdk/integrations/svelte/api#t-component) component. This value will be used when no translation
...
[`getTranslate`](/docs/sdk/integrations/svelte/api#gettranslate-function) method returning store containing

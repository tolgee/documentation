...
You have multiple options how to provide static i18n data to [`TolgeeProvider`](/docs/sdk/vue/api#tolgeeprovider) component.
...
[`TolgeeProvider's`](/docs/sdk/vue/api#tolgeeprovider) config prop.
...
supported language to [TolgeeProvider's](/docs/sdk/vue/api#tolgeeprovider) config prop.

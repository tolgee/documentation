...
browser by tolgee JS library. See [Tolgee JS docs](/js-sdk/text-observer).

:::info
When using with PHP, you have to use [Text Observer](/js-sdk/text-observer) on the client side.
:::

...
[deploy it on your cloud infrastructure](/docs/platform/self_hosting/running_with_docker#running-with-compose) with production
...
We are constantly improving Tolgee and we would be happy for any type of

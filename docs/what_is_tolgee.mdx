...
You can [deploy Tolgee on your local machine](/platform/self_hosting/running_with_docker#running-it-locally)
and use it for your local localization management, you can
[deploy it on your cloud infrastructure](/platform/self_hosting/running_with_docker#running-with-compose),

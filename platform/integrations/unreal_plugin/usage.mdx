...
**Note**: This action requires valid translation targets. If you haven't set those up yet, please refer to [localization setup in Unreal Engine](#Localization-setup-in-Unreal-Engine).

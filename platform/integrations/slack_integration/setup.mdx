...
Tolgee Slack Integration is available in the Advanced and Enterprise plans. [Upgrade your plan](https://tolgee.io/pricing) to use this feature.
...
You can also use the Tolgee Slack integration with the self-hosted version of Tolgee. Your setup will be a bit different.
 You need to create your own Slack and then configure the Tolgee app to use your self-hosted Tolgee instance.

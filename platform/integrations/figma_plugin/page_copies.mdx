...
When your project uses [branching](/platform/branching/overview), the branch is a setting of the whole file, while the language belongs to the page. A copy keeps its language, but follows the file's branch: the selector on a copy is read-only, and the branch is changed in `Settings` or from the main page.

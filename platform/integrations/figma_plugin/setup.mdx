...
You can click on whichever variables you like and add them. In between the parts, you can use separators of your liking by just typing or even text. In the example, you can see just the use of the "." in between the parts.

<FigmaScreenshotWrapper src="/img/docs/platform/figma-plugin/prefill-key-names.gif" />

**Formatting style** selector lets you change how the infromation from figma will be processed when prefilling keys. More specifically, it changes how spaces between words and capitalization will look.

...
In the **String details** page, you can define a variable by using the same syntax you know from Tolgee (`{varName}`) and mark a string as plural by checking the **Plural** checkbox.

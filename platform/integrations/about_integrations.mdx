...
image: /img/og-images/integrations.png
---

import { ScreenshotWrapper } from '../shared/_ScreenshotWrapper';

Easiest way to integrate Tolgee with your application is to open the **Integrate page**, which you can find in the project menu.
...
[React Native](/js-sdk/integrations/react/react_native), [Vanilla JS](/js-sdk/integrations/vanilla/installation).

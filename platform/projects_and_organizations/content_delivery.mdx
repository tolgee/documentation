...
If you use the self-hosted version, you can connect to your own storage in [server configuration](/platform/self_hosting/configuration#tolgee-contentdelivery-_-contentdelivery).

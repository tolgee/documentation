...
:::info Branching
When branching is enabled, exported translations reflect the active branch. See [Scope and Integrations](/platform/branching/scope_and_integrations) for details.
:::

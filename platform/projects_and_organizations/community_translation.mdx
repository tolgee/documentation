...
Contributors don't have to work inside Tolgee. If your website uses the Tolgee JS SDK, they can suggest translations directly on the site. Read more in [Community Translation in Context](./community_translation_in_context.mdx).

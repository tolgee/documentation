...
<ScreenshotWrapper
  ...
  src="/img/docs/platform/ai-settings/prompts-list.png"
/>

In this section you can see all custom prompts for current project. 

### Adding new prompt

Click on `+ Prompt` (or `Open AI Playground` if the list is empty), this will redirect you to the
[AI Playground](./ai_playground.mdx) with default prompt, which you can edit and save as a custom prompt.

### Managing prompts

Click on `⋮` icon next to any custom prompt to see a prompt menu.

<ScreenshotWrapper
  alt="Providing project description"
  src="/img/docs/platform/ai-settings/prompts-menu.png"
/>
...
<ScreenshotWrapper
  alt="Providing project description"
  src="/img/docs/platform/ai-settings/project-description.png"
/>
...
<ScreenshotWrapper
  ...
  src="/img/docs/platform/ai-settings/language-notes.png"
/>

...
comment without being invited. Once the first of them contributes, the Members page splits into a
`Team` tab and a `Community` tab. The `Team` tab holds your project members, and the `Community`
tab lists the contributors.

<ScreenshotWrapper
  src="/img/docs/platform/community-translation/members-community-tab.webp"
  alt="Community tab on the Members page listing contributors"
/>

To turn an active contributor into a full member, use `Invite to Team` on their row. Read more in
[Community Translation](./community_translation.mdx#see-who-has-contributed).
...
:::info
On a [public project](./community_translation.mdx), any signed-in user also gets limited **community permissions** that let them view and suggest without being a member. Community members do not appear in this list and do not use a paid seat.
:::
...
Granular permissions are available in the Advanced and Enterprise plans. [Upgrade your plan](https://tolgee.io/pricing) to use this feature.

...
Tasks are available in the Business, Advanced, and Enterprise plans. [Upgrade your plan](https://tolgee.io/pricing) to use this feature.
...
:::info Branching
When branching is enabled, tasks are scoped to the active branch. See [Tasks and Branches](/platform/branching/tasks) for details.
:::
...
- **Copy with key names** – this creates a copy with all texts replaced with the corresponding key names. This can be useful for developers so that they know what key names to use in code.

...
The i18next library uses custom format to represent localizations. With Tolgee, you're able to import and export json files with this format, but not all features are supported.
We recommend using ICU plugin for i18next and exporting translations in that format instead as more features are supported for the ICU format. [Read more](i18next_json.mdx)

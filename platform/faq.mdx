...
![Tolgee Platform](/img/tolgee-platform.png)
...
<video loop autoPlay muted style={{ maxWidth: '100%', margin: '0 auto' }}>
  <source src="/assistance.webm"></source>
</video>
...
<video loop autoPlay muted style={{ maxWidth: '100%', margin: '0 auto' }}>
  <source src="/alt-click-magic.webm"></source>
</video>
...
Tolgee has integrations for React, Angular, Vue, Svelte, Next.js, and Gatsby. Learn more here.
...
or read [integration docs](/integrations).

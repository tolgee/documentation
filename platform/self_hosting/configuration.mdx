...
See [Baidu's](https://fanyi-api.baidu.com/product/11) page for more information and applicable pricing.
...
### action
Whether the results should be interfered by the user-defined termbase.

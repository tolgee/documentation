...
By default, self-hosted instances send anonymous data about usage to help us improve Tolgee.:::infoThis was added in Tolgee Platform v3.23.0:::Once a day we collect following data
- number of projects
- number of languages

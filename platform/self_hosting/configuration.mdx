...
### action
Whether the resulting translation should be changed acccording to the user-defined termbase.
See [Manage Terms](https://fanyi-api.baidu.com/manage/term). (default: `false`)

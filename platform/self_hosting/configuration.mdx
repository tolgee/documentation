...
### enabled
If you are authenticating using a different method than explicit access key and secret key above, which implicitly enable AWS Translate,
you should enable AWS Translate using this.
...
### action
Whether the resulting translation should be changed acccording to the user-defined dictionary.

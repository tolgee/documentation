...
- <h5 id="app-name"><code>APP_NAME</code></h5>
...
TOLGEE_AUTHENTICATION_USER_CAN_CREATE_PROJECTS=true
...
- <h5 id="app-name"><code>app-name</code></h5>
...
tolgee.authentication.user-can-create-projects = true

...
- ##### `initial-username` {#initial-username}
  ...
  :::tip
  If you have updated the `initial-username` password via the Tolgee web UI and need to reset it to the `initial-password`; set the password_changed field to 'false' in the user_account table. Restarting the container will now allow you to use your `initial-password` for logging in.
  :::

...
- ##### `initial-password` {#initial-password}
  ...
  If your the password was changed through UI, set the `password_changed` field to 'false' in the `user_account` table (in your DB). Restarting the container will now allow you to use your `initial-password` for logging in.
  :::

...
If you're Azure user, we have prepared a Marketplace image for you. You can find it [here !!!replace with real link!!!](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/strapi.strapi?tab=Overview).

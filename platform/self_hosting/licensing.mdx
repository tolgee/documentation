...
If you use the self-hosted version of Tolgee and want to use the advanced features, you need a licensed plan.
Licensed self-hosted plans are tailored to your needs and require contacting us first. For more details, see the [self-hosting pricing page](https://tolgee.io/pricing/self-hosted).

## Getting a licensed plan

[Contact us](mailto:sales@tolgee.io) to discuss your needs. We will set up a custom plan for you in Tolgee Cloud. Once the plan is ready, you can subscribe to it and get your license key.

:::note
Cloud subscriptions and self-hosted licenses are separate. A cloud plan does not apply to your self-hosted instance.
:::

## Subscribing to a plan

Once we have set up a custom plan for you, open Tolgee Cloud and go to the [Subscription page of your organization](https://app.tolgee.io/billing-self-hosted).
...
![License key](/img/docs/platform/subscription_license_key.webp)

## Applying the license key

Open the **Server administration on your self-hosted instance**.

Once you navigate to the "License" tab, **paste the license key** into the input field and click the "Apply license key" button.

![Self-hosted instance – apply license key](/img/docs/platform/subscription_self-hosted_license_key.webp)

You will be **prompted to confirm the license key** application. Then, click on the "Confirm" button.

![Self-hosted instance – confirm license key](/img/docs/platform/subscription_self-hosted_license_key_confirmation.webp)
...
![Self-hosted instance – activated plan](/img/docs/platform/subscription_self-hosted_plan.webp)
...
![Cancel subscription](/img/docs/platform/subscription_self-hosted_cancel.webp)
...
![Confirm cancellation](/img/docs/platform/subscription_self-hosted_cancel_confirm.webp)

...
import { CodeWithVersion } from '../../src/component/CodeWithVersion';
...
<CodeWithVersion code={'docker run -v tolgee_data:/data/ -p 8085:8080 tolgee/tolgee{{version}}'} />
...
<CodeWithVersion title="docker-compose.yml" code={`\
version: '3'\n
services:
  db:
    image: postgres:11

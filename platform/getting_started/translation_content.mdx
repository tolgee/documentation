...
- Install and initialize the SDK: [Installation](/android-sdk/installation.mdx)
...
In production, configure content delivery (CDN) using the Android [Production guide](/android-sdk/production), and preload data as needed.

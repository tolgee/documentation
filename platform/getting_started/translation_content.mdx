...
- Use localized composables and react to locale changes: [Jetpack Compose](/android-sdk/jetpack-compose)

In production, configure content delivery (CDN) as described in the Android [Installation](/android-sdk/installation) page and preload data as needed.

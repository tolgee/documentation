...
- Install and initialize the SDK: [Quickstart](/android-sdk/core-module/quickstart)
- Use translations in Views and handle plurals/parameters: [Usage](/android-sdk/core-module/usage)
- Use localized composables: [Jetpack Compose](/android-sdk/jetpack/quickstart)   

In production, configure content delivery (CDN) using the Android [Quickstart](/android-sdk/core-module/quickstart) and [Production guide](/android-sdk/production), and preload data as needed.

...
- **Free** - Our **cloud version** is **free for any open-source projects**. For commercial projects, you can use Tolgee for free up to 500 keys. For more information, see [pricing](https://tolgee.io/pricing).

---
id: about_tolgee
title: What is Tolgee? Developer-Friendly Localization & Translation Platform
...
Tolgee is a developer-focused platform, so it is **easy to integrate** with your application without big code changes.
...
- **Developer-friendly** - Tolgee is designed to be easy to integrate with your application. There are integrations for web frameworks like react localization and Next.js localization via the [Tolgee JS SDK](/js-sdk) and for native mobile apps via the [Tolgee iOS SDK](/ios-sdk) and [Tolgee Android SDK](/android-sdk).
...
- **Open-source** - Tolgee is open-source, you can contribute to the project on our [GitHub repository](https://github.com/tolgee/tolgee-platform). You can also use it for self-hosted localization by [hosting your own instance](/platform/self_hosting/getting_started) of Tolgee, so you can have full control over your data.
...
- **AI translator** — [AI Translator](/platform/translation_process/ai_translator) can make software localization and app translation much faster and more autonomous. It provides more accurate translations than general translators as it gathers context through Tolgee's native JS SDKs, which provide in-context dialogs.
...
- [Tolgee JavaScript localization SDK](/js-sdk)

...
You need to select one of the languages as a **base language** - this language will be used as a source of translations. You can add languages to project later in the [Languages settings](/platform/projects_and_organizations/languages#editing-languages).

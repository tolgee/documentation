...
import { ScreenWrapper } from '../shared/_ScreenWrapper';
...
You need to select one of the languages as a **base language** – this language will be used as a source of translations. You can add more languages later in the [Languages settings](/platform/projects_and_organizations/languages#languages-settings).

...
The plugin is branch-aware. Pick a branch in `Settings` or from the plugin header, and every upload and download targets it. The branch is a setting of the whole Figma file, so page copies follow it too.

→ [Setup and Settings](/platform/integrations/figma_plugin/setup)

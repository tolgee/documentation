...
Go to **Branching** in the project sidebar. Click the **Merge icon button** next to the branch you want to merge. Tolgee immediately opens the merge preview page.
...
<ScreenshotWrapper
  ...
  alt="Merge completion area showing Delete after merge checkbox and Complete the merge button"
/>

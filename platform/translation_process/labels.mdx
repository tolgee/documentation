...
Labels are available in the Advanced and Enterprise plans. [Upgrade your plan](https://tolgee.io/pricing) to use this feature.

If you use the self-hosted version, labels are also available in the Advanced and Enterprise plans, and you need to [set up the license](/platform/self_hosting/licensing) to use this feature.
:::

...
When Tolgee requests a translation from DeepL, it also sends the key description as context. DeepL uses the description to choose the right meaning, tone and grammatical form of the translated text.

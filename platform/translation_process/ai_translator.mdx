...
Unless you pick a concrete model for your prompt, the AI Translator uses the server's default model. The default is
regularly updated to the model that performs best for translation, so your translations keep improving without any
action on your side. You can [choose a model per prompt](./ai_playground.mdx#choose-a-model) in the AI Playground.

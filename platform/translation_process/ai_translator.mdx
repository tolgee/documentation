...
cell and at the with a little ⚡ icon. By clicking on the icon, you can see the context.

## AI Translator customization

You can customize the AI Translator via [AI Playground](../projects_and_organizations/ai_playground.mdx)

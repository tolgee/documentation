...
## Key description
Key descriptions can help translators to understand the context of the key. It's also provided to the Tolgee AI translator
to help it understand the key.

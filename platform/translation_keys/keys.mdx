...
- Use the editor to [create a single translation key](#creating-translation-keys) and adjust its options as needed.
...
To create a new translation key, click the `+ Add` button on the project's `Translations` page.
...
- **Namespace**: The namespace of the key. This is an optional field that can be used to structure keys into different "buckets". You can learn more on the [Namespaces](namespaces) page.

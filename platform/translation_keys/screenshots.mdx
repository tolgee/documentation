...
You can upload screenshots to Tolgee to help translators to better understand what they should translate. You can add screenshots to any key.

## Adding screenshots to Tolgee
To add screenshot to your key, click the `Screenshots` button in the key detail:

![Key screenshots button](/img/docs/platform/key_screenshots.png)

After you click on the button, you can select the screenshot you want to upload or drag 'n' drop the screenshot to the upload form.
